...
def main():
    ...
    # Add argument
    parser.add_argument('--dataset', default='kiba', help='davis or kiba')
    parser.add_argument('--model_path', default='/opt/data/private/pbp/MGraphDTA-devecfpGATv2GCNmlp1300/regression/save/20240419_143805_kiba/model/epoch-2566, loss-0.0104, cindex-0.9795, test_loss-0.1315.pt', type=str, help='model path ready to load')
    ...
    model = GETDTA(3, 25 + 1, embedding_num=128, filter_num=32, out_dim=1).to(device)
